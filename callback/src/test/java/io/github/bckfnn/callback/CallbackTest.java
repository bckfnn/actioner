...
public class CallbackTest {
    ...
    public void runOk1() {
        ...
        runOk(Callback.callback(res -> {
            events.add("continue");
            events.add(res.result());
        }));
    ...
    public void runOk2() {
        events.add("start");
        subRunOk2(Callback.callback(res -> {
            events.add("end");
            events.add(res.result());
        }));
    ...
    public void runFail() {
        events.add("start");
        runFail(Callback.callback(v -> {
            events.add("continue");
            events.add(v.cause().getMessage());
        }));
    ...
    public void runFail2() {
        events.add("start");
        subRunFail2(Callback.callback(res -> {
            events.add("end");
            events.add(res.cause().getMessage());
        }));
    ...
    public void runFail3() {
        events.add("start");
        subRunFail3(Callback.callback(res -> {
            events.add("end");
            events.add(res.cause().getMessage());
        }));
