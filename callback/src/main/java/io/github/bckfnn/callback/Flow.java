...
public class Flow {
    ...
    public static <T> void forEachx(List<T> list, BiConsumer<T, Handler<AsyncResult<Void>>> x, Handler<AsyncResult<Void>> handler) {
    ...
    public static <T> void forEachx(List<T> list, int chunks, BiConsumer<T, Handler<AsyncResult<Void>>> x, Handler<AsyncResult<Void>> handler) {
